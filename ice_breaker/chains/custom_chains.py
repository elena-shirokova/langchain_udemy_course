...
llm = ChatOpenAI(
    ...
    openai_api_key="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",
)
...
def get_ice_breaker_chain() -> LLMChain:
    ice_breaker_template = """
         given the information about a person from linkedin {information}, and twitter posts I want you to create:
